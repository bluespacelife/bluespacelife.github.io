...
! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Valine = t() : e.Valine = t() }(this, function() {
    return function(e) {
        ...
        */
        ...
        function r(e) { var t = this; return !!e && t.init(e), t }
        ...
        var o = n(9).version,
            ...
            f = n(7),
            h = /^https?\:\/\//,
            v = { comment: "", nick: "匿名", mail: "", link: "", ua: navigator.userAgent, url: "" },
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                if (n && r && t.installLocale(n, r), t.locale = t.locale || g[n || "zh-cn"], t.notify = c || !1, t.verify = d || !1, x) {
                    ...
                    O.parentNode.insertBefore(A, O), window.getIP = function(e) { v.ip = e.ip }
                }
                m.params = "?d=" + (w.indexOf(i) > -1 ? i : "mp") + "&v=" + o + _, m.hide = "hide" === i, m.cdn = h.test(l) ? l : m.cdn, y = e.path || y;
                var S = Number(p || 10);
                if (e.pageSize = isNaN(S) ? 10 : S < 1 ? 10 : S, s.setOptions({ renderer: new s.Renderer, highlight: !1 === e.highlight ? null : f, gfm: !0, tables: !0, breaks: !0, pedantic: !1, sanitize: !1, smartLists: !0, smartypants: !0 }), !AV) return void setTimeout(function() { t.init(e) }, 20);
                var $ = e.app_id || e.appId,
                    E = e.app_key || e.appKey;
                AV.applicationId && delete AV._config.applicationId || (AV.applicationId = null), AV.applicationKey && delete AV._config.applicationKey || (AV.applicationKey = null), AV.init({ appId: $, appKey: E });
                for (var C = u.findAll(document, ".valine-comment-count"), M = 0, T = C.length; M < T; M++) ! function(e, n) {
                    var r = C[e];
                    if (r) {
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(P, ".vcancel"), function(e) { t.alert.hide() }), u.attr(P, "style", "display:block;"), e && e.type) {
                            var o = u.find(P, ".vsure");
                            u.on("click", o, function(n) { t.alert.hide(), e.cb && e.cb() })
                        }
                        return t
                    },
                    hide: function() { return u.attr(P, "style", "display:none;"), t }
                }, t.bind(e)
        ...
        r.prototype.Q = function(e) {
            ...
            for (var w = e.meta, k = {}, _ = { veditor: "comment" }, A = 0, O = w.length; A < O; A++) _["v" + w[A]] = w[A];
            for (var S in _) _.hasOwnProperty(S) && function() {
                var e = _[S],
                    n = u.find(t.el, "." + S);
                k[e] = n, n && u.on("input change blur", n, function(t) { "comment" === e ? b(n) : v[e] = u.escape(n.value.replace(/(^\s*)|(\s*$)/g, "")) })
            }();
            var $ = function(e, t) {
                ...
                C = function n() {
                    ...
                    a.limit(i), a.skip((r - 1) * i), a.find().then(function(e) {
                        ...
                        p && u.on("click", p, function(e) { d.innerHTML = "", n(++r) }), t.loading.hide()
            ...
            var M = function(e, n, r) {
                    ...
                    for (var h = u.find(i, ".vat"), v = u.findAll(i, "a"), b = 0, x = v.length; b < x; b++) {
                        var y = v[b];
                        y && -1 == (u.attr(y, "data-at") || "").indexOf("at") && u.attr(y, { target: "_blank", rel: "nofollow" })
                    }
                ...
                L = function(e) { setTimeout(function() { e.offsetHeight > 180 && (e.classList.add("expand"), u.on("click", e, function(t) { u.attr(e, "class", "vcontent") })) }) },
                z = {},
                R = function(e, t) {
                    u.on("click", e, function(e) {
                        var n = "@" + u.escape(t.get("nick"));
                        z = { at: u.escape(n) + " ", rid: t.get("rid") || t.id, pid: t.id, rmail: t.get("mail") }, u.attr(k.comment, "placeholder", n), k.comment.focus()
                    })
                };
            ! function() {
            ...
            var B = function() { v.comment = "", k.comment.value = "", b(k.comment), u.attr(k.comment, "placeholder", t.placeholder), z = {}, t.preview.empty().hide() },
                j = u.find(t.el, ".vsubmit"),
                I = function(e) { return u.attr(j, "disabled") ? void t.alert.show({ type: 0, text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"', ctxt: t.locale.ctrl.ok }) : "" == v.comment ? void k.comment.focus() : (v.nick = v.nick || "匿名", void(t.notify || t.verify ? N(U) : U())) },
                P = function() { var e = new AV.ACL; return e.setPublicReadAccess(!0), e.setPublicWriteAccess(!1), e },
                U = function() {
                    ...
                    if (v.url = decodeURI(y), v.insertedAt = new Date, z.rid) {
                        var r = z.pid || z.rid;
                        n.set("rid", z.rid), n.set("pid", r), v.comment = v.comment.replace("<p>", '<p><a href="#' + r + '">' + z.at + "</a> , ")
                    }
                    for (var i in v)
                    ...
                    n.setACL(P()), n.save().then(function(e) {
                        "匿名" != v.nick && x && x.setItem("ValineCache", JSON.stringify({ nick: v.nick, link: v.link, mail: v.mail }));
                        ...
                        try {
                            ...
                            v.mail && Q({ username: v.nick, mail: v.mail }), z.at && z.rmail && t.notify && V({ username: z.at.replace("@", ""), mail: z.rmail }), u.removeAttr(j, "disabled"), t.loading.hide(), B()
                        } catch (e) { t.ErrorHandler(e) }
                ...
                Q = function(e) { var t = new AV.User; return t.setUsername(e.username), t.setPassword(e.mail), t.setEmail(e.mail), t.setACL(P()), t.signUp() },
                V = function e(n) { AV.User.requestPasswordReset(n.mail).then(function(e) {}).catch(function(r) { 1 == r.code ? t.alert.show({ type: 0, text: "ヾ(ｏ･ω･)ﾉ At太频繁啦，提醒功能暂时宕机。<br>" + r.error, ctxt: t.locale.ctrl.ok }) : Q(n).then(function(t) { e(n) }).catch(function(e) {}) }) };
            u.on("click", j, I), u.on("keydown", document, function(e) {
                e = event || e;
        ...
        var a = /[&<>"'`\\]/g,
            ...
            c = RegExp(l.source),
            d = {
                on: function(e, t, n, r) { e = e.split(" "); for (var i = 0, o = e.length; i < o; i++) d.off(e[i], t, n, r), t.addEventListener ? t.addEventListener(e[i], n, r || !1) : t.attachEvent ? t.attachEvent("on" + e[i], n) : t["on" + e[i]] = n },
                off: function(e, t, n, r) { t.removeEventListener ? t.removeEventListener(e, n, r || !1) : t.detachEvent ? t.detachEvent("on" + e, n) : t["on" + e] = null },
                escape: function(e) { return e && s.test(e) ? e.replace(a, function(e) { return i[e] }) : e },
                unescape: function(e) { return e && c.test(e) ? e.replace(l, function(e) { return r[e] }) : e },
                create: function(e, t, n) { var r = document.createElement(e); return d.attr(r, t, n), r },
                ...
                attr: function(e, t, n) {
                    ...
                    if (void 0 !== n) null === n ? d.removeAttr(e, t) : e.setAttribute(t, n);
                        ...
                        d.each(t, function(t, n) { e.setAttribute(t, n) })
                    }
                },
                prop: function(e, t, n) { return void 0 !== n ? e[t] = n : "[object Object]" !== {}.toString.call(t) ? e[t] : void d.each(t, function(t, n) { e[t] = n }) },
        ...
        ! function(i) {
            ...
            function _(e, t, n) { return t ? n ? w(t, e) : k(t, e) : n ? x(e) : y(e) }
